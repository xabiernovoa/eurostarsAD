...
def segment(
    ...
    embeddings_path = embeddings_path or os.path.join(DATA_DIR, "embeddings.json")
    customers_path = customers_path or os.path.join(DATA_DIR, "customer_data_200.csv")
...
def save(segments: dict, path: str | None = None) -> str:
    path = path or os.path.join(DATA_DIR, "segments.json")

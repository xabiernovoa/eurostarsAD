...
const EUROSTARS_IMAGES = path.join(PROJECT_ROOT, 'images');
...
const server = http.createServer((req, res) => {
    ...
    if (pathname.startsWith('/api/email/')) {
        ...
        const imagePrefix = `src="${EUROSTARS_IMAGES.replace(/\\/g, '/')}/`;
        content = content.replaceAll(imagePrefix, 'src="/images/eurostars/');
        content = content.replaceAll('src="/home/xabier/Documentos/eurostars/images/', 'src="/images/eurostars/');
